<template>
  <div style="margin-top:100px">
    <el-form ref="ruleForm" :rules="rules" :label-position="top"
             label-width="100px" :model="ruleForm" style="max-width: 460px; margin:auto">
...
export default {
  ...
  methods: {
    submitForm(formName) {
      console.log("zo day ne: ",this.$refs[formName])
      this.$refs[formName].validate((valid) => {
        console.log("valid trong submit: ", valid)
